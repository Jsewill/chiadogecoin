...
testnet_kwargs = {
    ...
    "DIFFICULTY_CONSTANT_FACTOR": 2 ** 40,
    ...
    # Forks of chiadoge should change this value to provide replay attack protection. This is set to mainnet genesis chall
    "AGG_SIG_ME_ADDITIONAL_DATA": bytes.fromhex("222e518766769aa5ef496a70e6f63f77cd99e1486a435117713ee81089991a8f"),
