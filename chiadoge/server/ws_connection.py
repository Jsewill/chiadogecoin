...
from chiadoge.cmds.init_funcs import chiadoge_full_version_str
from chiadoge.protocols.protocol_message_types import ProtocolMessageTypes
from chiadoge.protocols.shared_protocol import Capability, Handshake
from chiadoge.server.outbound_message import Message, NodeType, make_msg
from chiadoge.server.rate_limits import RateLimiter
...
from chiadoge.util.network import class_for_type, is_localhost

# Max size 2^(8*4) which is around 4GiB
LENGTH_BYTES: int = 4


class WSChiadogeConnection:
    """
