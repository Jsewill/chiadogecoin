...
from chiadoge.consensus.pot_iterations import calculate_sp_iters, is_overflow_block
from chiadoge.protocols import timelord_protocol
from chiadoge.protocols.protocol_message_types import ProtocolMessageTypes
from chiadoge.server.outbound_message import NodeType, make_msg
from chiadoge.server.server import ChiadogeServer
from chiadoge.timelord.iters_from_block import iters_from_block
from chiadoge.timelord.timelord_state import LastState
from chiadoge.timelord.types import Chain, IterationType, StateType
from chiadoge.types.blockchain_format.classgroup import ClassgroupElement
from chiadoge.types.blockchain_format.reward_chain_block import RewardChainBlock
from chiadoge.types.blockchain_format.sized_bytes import bytes32
from chiadoge.types.blockchain_format.slots import (
...
from chiadoge.types.blockchain_format.vdf import VDFInfo, VDFProof
...
class Timelord:
    def __init__(self, root_path, config: Dict, constants: ConsensusConstants):
        ...
        self.server: Optional[ChiadogeServer] = None
